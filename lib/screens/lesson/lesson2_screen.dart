    ...
    var lessons = [
      VideoLesson(const [
        ...
        'Letra Z'
          ...
          'images/Leccion2.mp4', 'Lección 2', 'El Abcedario', 1,
      ...
      GridLesson(
          ...
          checkButton: bottomButton(context, 'SIGUIENTE'),
          1),
      DragLesson('images/p.gif', ['P', 'R', 'Q', 'S', 'M', 'L'], const ['P'],
          checkButton: bottomButton(context, 'SIGUIENTE')),
      ...
      GridLesson(
          ...
          checkButton: bottomButton(context, 'SIGUIENTE'),
          1),
      ListLesson('Cual es la siguiente seña', const ["Y", 'X', 'C', 'Z'],
          'images/c.png', 'C',
          checkButton: bottomButton(context, 'SIGUIENTE')),
      ...
      GridLesson(
          ...
          checkButton: bottomButton(context, 'SIGUIENTE'),
          1),
      ListLesson('Cual es la siguiente seña', const ["M", 'P', 'N', 'X'],
          'images/x.png', 'X',
          checkButton: bottomButton(context, 'SIGUIENTE')),
    ];
