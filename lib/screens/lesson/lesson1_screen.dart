  ...
  Widget build(BuildContext context) {
    var lessons = [
      VideoLesson(const [
        ...
        'Letra O',
        'Letra U'
      ], """   En el lenguaje de señas venezolano, las vocales juegan un papel fundamental en la comunicación gestual, sirviendo como bloques de construcción esenciales para transmitir significados precisos. Aprender a representar correctamente las vocales en el lenguaje de señas es crucial para garantizar la claridad y comprensión de los mensajes. La práctica regular es fundamental  para mejorar la fluidez y la precisión en la realización de estos gestos.""",
          'images/Leccion1.mp4', 'Lección 1', 'Las Vocales', 1,
