  ...
  Widget build(BuildContext context) {
    var lessons = [
      VideoLesson(const [
        ...
        'Color Rojo',
        'Color Verde'
      ], " En la lengua de señas venezolana, los colores son elementos clave para describir objetos, expresar emociones y facilitar la comunicación visual. Cada color tiene un signo específico que permite transmitir información de manera clara y efectiva. Aprender y practicar estos signos es fundamental para mejorar la fluidez en la comunicación y ampliar el vocabulario en LSV",
          'images/Leccion3.mp4', 'Lección 3', 'Los Colores', 1,
